...
public class DirectorMainMenu {
    ...
    public void AccountPressed(ActionEvent actionEvent)
    {
        try {
            ...
            loader.setLocation(DirectorMainMenu.class.getResource("/main/UserAccountScene.fxml"));
    ...
    public void ShowUsersPressed()
    {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(DirectorMainMenu.class.getResource("/main/director/ShowUsersScene.fxml"));
            AnchorPane pane = loader.load();
            mainPane.getChildren().add(pane);
            ShowUsers userMenu = loader.getController();
            userMenu.setVisibleToolbar();
        }
        catch (Exception e) {
            System.out.println("Ошибка " + e);
        }
    ...
    public void ShowEmployeesPressed(ActionEvent actionEvent)
    {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(DirectorMainMenu.class.getResource("/main/user/ShowEmployeesScene.fxml"));
            AnchorPane pane = loader.load();
            mainPane.getChildren().add(pane);
            ShowEmployees employeeMenu = loader.getController();
            employeeMenu.setVisibleToolbar();
        }
        catch (Exception e) {
            System.out.println("Ошибка " + e);
        }
    ...
    public void ShowPostsPressed(ActionEvent actionEvent)
    {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(DirectorMainMenu.class.getResource("/main/user/ShowPostsScene.fxml"));
            AnchorPane pane = loader.load();
            mainPane.getChildren().add(pane);
            ShowPosts postMenu = loader.getController();
            postMenu.setVisibleToolbar();
        }
        catch (Exception e) {
            System.out.println("Ошибка " + e);
        }
    ...
    public void ShowDepartmentsPressed(ActionEvent event)
    {
        ...
        {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(DirectorMainMenu.class.getResource("/main/user/ShowDepartmentsScene.fxml"));
            AnchorPane pane = loader.load();
            mainPane.getChildren().add(pane);
            ShowDepartments departmentMenu = loader.getController();
            departmentMenu.setVisibleToolbar();
        }
        catch (Exception e) {
            System.out.println("Ошибка " + e);
        }
    ...
    public void FinancePressed(ActionEvent actionEvent)
    {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(DirectorMainMenu.class.getResource("/main/admin/AdminFinanceWindow.fxml"));
            AnchorPane pane = loader.load();
            mainPane.getChildren().add(pane);
        }
        catch (Exception e) {
    ...
    {
        {
            try {
                ...
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(DirectorMainMenu.class.getResource("/main/SignInWindow.fxml"));
                loader.load();
