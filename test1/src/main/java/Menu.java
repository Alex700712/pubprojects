...
public class Menu {
        ...
        try {
            while (!back) {
                ...
                switch (choose_value) {
                    ...
                    case 3: {
                        System.out.println("""
                                Name of organization is only updateable field
    ...
    public <T> void DeleteOperation(T entity, Service service)
    {
        if (entity != null) {
